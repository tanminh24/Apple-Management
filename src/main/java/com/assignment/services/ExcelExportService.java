...
public class ExcelExportService {
    ...
    private void writeCategoryHeaderLine(CellStyle style) {
        ...
        createCell(rowC, 2, "Số lượng sản phẩm", style);
        createCell(rowC, 3, "Trạng thái", style);
    }
    ...
    public void writeProductDataLine(CellStyle style) {
        ...
        for (Product p : productRepo.findAll()) {
            ...
            createCell(rowP, columnCount++, p.getCategoryId().getName(), style);
    ...
    public void writeCategoryDataLine(CellStyle style) {
        ...
        for (Category c : categoryRepo.findAll()) {
            ...
            createCell(rowC, columnCount++, c.getQuantityProduct(), style);
            createCell(rowC, columnCount++, (c.getAvailable() == 0) ? "Đang bán" : "Ngưng bán", style);
        }
    }
